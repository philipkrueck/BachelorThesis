...
The process of marking appropriate instances as \code{const} was facilitated by using the linter rule \texttt{prefer\_const\_constructor} (see \cite{ConstLinterRule2021}) for the Dart Static Analyzer (\cite{DartCodeAnalysis2021}). 
