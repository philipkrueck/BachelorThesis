...
\subsection{Hyptothesis Evaluation}
...
For most use cases participants had to go through use cases multiple times in order to find differences between the two applications.
